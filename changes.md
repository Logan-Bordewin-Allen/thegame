...
- player health does not reset after game is completed if playerid does not change(page is reloaded)
- no way to restart game once one player has lost
- shop not properly opening
- reloading page gives you extra turns sometimes
...
- Draw spell feels weak should bump it to four cards
- Draw two button is pointless, just make starting hand size 7 unless there is smth I am not understanding
